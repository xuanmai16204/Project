        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoyaltyLevelId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RolePermissions_BusinessRoles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BusinessUserRoles_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmailCampaigns_AspNetUsers_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExportReports_AspNetUsers_GeneratedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SystemNotifications_AspNetUsers_PublishedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmailRecipients_EmailCampaigns_CampaignId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrdersHandled = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RewardPointTransactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RewardPointTransactions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RewardPointTransactions_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingService = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NotificationRecipients_SystemNotifications_SystemNotificationId",
            ...
            migrationBuilder.InsertData(
                table: "LoyaltyLevels",
                columns: new[] { "Id", "DiscountPercent", "Name", "ThresholdPoints" },
                values: new object[,]
                {
                    { 1, 0, "Seed", 0 },
                    { 2, 2, "Brew", 100 },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusinessUserRoles_UserId_RoleId",
                table: "BusinessUserRoles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmailRecipients_CampaignId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExportReports_GeneratedByUserId",
                table: "ExportReports",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationRecipients_SystemNotificationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RewardPointTransactions_OrderId",
                table: "RewardPointTransactions",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_RewardPointTransactions_UserId",
                table: "RewardPointTransactions",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SystemNotifications_PublishedByUserId",
